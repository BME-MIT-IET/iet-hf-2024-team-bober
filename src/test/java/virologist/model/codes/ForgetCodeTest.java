...
class ForgetCodeTest {
    ...
    @BeforeEach
    public void init() {
        forgetCode = new ForgetCode(aminoAcidPrice, nucleotidePrice, turnsLeft);
    ...
    void create_virologist_has_enough_aminoAcid_and_nucleotide() throws Exception {
        ...
        // Act and Assert
        assertDoesNotThrow(() -> forgetCode.Create(virologist));
