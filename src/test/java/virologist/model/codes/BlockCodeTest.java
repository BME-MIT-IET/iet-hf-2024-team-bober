...
class BlockCodeTest {
    ...
    int aminoAcidPrice = 4;
	int nucleotidePrice = 3;
	int turnsLeft = 2;
    private Virologist virologist;

    @BeforeEach
    public void init() {
        blockCode = new BlockCode(aminoAcidPrice, nucleotidePrice, turnsLeft);
    ...
    void create_virologist_has_enough_aminoAcid_and_nucleotide() throws Exception {
        ...
        // Act and Assert
        assertDoesNotThrow(() -> blockCode.Create(virologist));
