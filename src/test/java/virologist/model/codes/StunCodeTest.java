...
class StunCodeTest {
    private StunCode stunCode;
    int aminoAcidPrice = 7;
	int nucleotidePrice = 2;
	int turnsLeft = 1;
    private Virologist virologist;

    @BeforeEach
    public void init() {
        stunCode = new StunCode(aminoAcidPrice, nucleotidePrice, turnsLeft);
    ...
    void create_virologist_has_enough_aminoAcid_and_nucleotide() throws Exception {
        ...
        // Act and Assert
        assertDoesNotThrow(() -> stunCode.Create(virologist));
